...
import practica5.ataxx.AtaxxFactoryExt;
import practica5.attt.ATTTFactoryExt;
import practica5.connectn.ConnectNFactoryExt;
import practica5.ttt.TTTFactoryExt;
	...
	*/
	...
	private static void parseGameOption(CommandLine line) throws ParseException {
		...
		case AdvancedTicTacToe:
			gameFactory = new ATTTFactoryExt();
			break;
		case CONNECTN:
		...
		case Ataxx:
			if (dimRows != null && dimCols != null) {
				...
				if(obstacles != null) {
					...
					gameFactory = new AtaxxFactoryExt(3);
				}
